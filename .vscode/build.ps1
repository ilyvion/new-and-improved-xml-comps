...
$VersionTargetSuffix = "Mods\NewAndImprovedXmlComps"
$Target = "$VersionTargetPrefix\1.5\$VersionTargetSuffix"

# build dlls
dotnet build --configuration $Configuration Source/NewAndImprovedXmlComps/NewAndImprovedXmlComps.csproj
...
New-Item -Path $Target\1.5\Assemblies\NewAndImprovedXmlComps.dll.hotswap -Type file
